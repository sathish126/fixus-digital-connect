...
const Navigation = () => {
  ...
  const handleQuoteClick = () => {
    const message = "Hi! I'm interested in FixUs services. Could you please provide more information?";
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Button 
                ...
                className="ml-4 bg-gradient-secondary hover:opacity-90 transition-smooth"
              >
